                    ...
                    <div class="header-info">
                        ...
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $app ? $app->business_email : 'vishal@test.com' }}">{{ $app ? $app->business_email : 'vishal@test.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $app ? $app->business_email : 'vishal@test.com' }}
                        </p>
